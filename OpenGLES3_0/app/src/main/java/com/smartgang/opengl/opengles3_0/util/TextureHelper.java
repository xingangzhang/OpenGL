package com.smartgang.opengl.opengles3_0.util;
...
public class TextureHelper {
    ...
    public static int loadTexture(Context context, int resourceId) {
        ...
        GLES30.glTexParameterf(GL_TEXTURE_2D, GLES30.GL_TEXTURE_WRAP_S, GLES30.GL_CLAMP_TO_EDGE);//纹理边缘延伸效果
        GLES30.glTexParameterf(GL_TEXTURE_2D, GLES30.GL_TEXTURE_WRAP_T, GLES30.GL_CLAMP_TO_EDGE);
