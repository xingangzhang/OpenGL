...
public class AirHockeyOrthoProgram extends ShaderProgram {
...
//    };
    ...
    public AirHockeyOrthoProgram(Context context, int vertexShaderResourceId, int fragmentShaderResourceId) {
